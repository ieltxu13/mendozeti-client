...
@Component({
  selector: 'app-listado-de-contactos',
  templateUrl: './listado-de-contactos.component.html',
  styleUrls: ['./listado-de-contactos.component.css']
})
export class ListadoDeContactosComponent implements OnInit {
  eti: any;
